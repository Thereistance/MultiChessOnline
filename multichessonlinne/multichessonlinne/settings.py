"""
Django settings for multichessonlinne project.
...
# SECRET_KEY = 'django-insecure-@jb!!$g!3tlynv=)fpvs@!0)0t)^432y25thch4yqfar%3)uw!'
...
ROOT_URLCONF = 'multichessonlinne.urls'
...
#        'USER': os.getenv('POSTGRES_USER', 'postgres'),
#         'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'maxjke114'),
#         'HOST': os.getenv('DATABASE_HOST', '127.0.0.1'),  # 'db' - имя сервиса в docker-compose
#         'PORT': os.getenv('DATABASE_PORT', '5432'),
#     }
# }
