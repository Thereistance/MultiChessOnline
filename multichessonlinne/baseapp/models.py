...
class Game(models.Model):
    ...
    player_1 = models.ForeignKey(Player,related_name='game_as_player1', default='Unknown', on_delete=models.SET_DEFAULT)
    player_2 = models.ForeignKey(Player,related_name='game_as_player2', null=True, blank=True, default='Unknown', on_delete=models.SET_DEFAULT)
